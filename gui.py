...
download_single_csv = html.Div(
    className="has-text-centered mb-6 no-print",
    children=[
        html.Div(
            className="control",
            children=[
        ...
        <div class="container">
            <div class="columns">
                ...
                <div class="column content is-size-5">
                    ...
                    <p>The <a href="https://www.alaska.edu/">University of Alaska</a> is an Equal Opportunity/Equal Access Employer and Educational Institution. The
